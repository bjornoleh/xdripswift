...
class SettingsViewDataSourceSettingsViewModel: NSObject, SettingsViewModelProtocol {
    ...
    func completeSettingsViewRefreshNeeded(index: Int) -> Bool {
        ...
        if (index == Setting.bloodGlucoseUnit.rawValue || index == Setting.masterFollower.rawValue || index == Setting.followerExtraRow2.rawValue || index == Setting.setActiveCGM.rawValue) {return true}
